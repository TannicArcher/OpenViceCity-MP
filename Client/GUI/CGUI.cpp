...
bool CGUI::Initialize()
{
	...
	if(!m_bInitialized)
	{
		...
		sprintf(resourcePath, "%s%s", "", "VCMP/CEGUI/schemes/");
		rp->setResourceGroupDirectory("schemes", resourcePath);
		sprintf(resourcePath, "%s%s", "", "VCMP/CEGUI/imagesets/");
		rp->setResourceGroupDirectory("imagesets", resourcePath);
		sprintf(resourcePath, "%s%s", "", "VCMP/CEGUI/fonts/");
		rp->setResourceGroupDirectory("fonts", resourcePath);
		sprintf(resourcePath, "%s%s", "", "VCMP/CEGUI/layouts/");
		rp->setResourceGroupDirectory("layouts", resourcePath);
		sprintf(resourcePath, "%s%s", "", "VCMP/CEGUI/looknfeel/");
		rp->setResourceGroupDirectory("looknfeels", resourcePath);
		sprintf(resourcePath, "%s%s", "", "VCMP/CEGUI/xml_schemas/");
