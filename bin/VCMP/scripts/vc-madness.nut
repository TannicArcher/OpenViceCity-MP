...
function onServerInit()
{
	...
	// Player classes
	addPlayerClass(0, 0, -673.2837, -1325.3040, 11.0715, 116.6886, 4, 1, 3, 35, 19, 15);
	addPlayerClass(1, 1, -673.2837, -1325.3040, 11.0715, 116.6886, 4, 1, 3, 35, 19, 15);
	addPlayerClass(2, 2, -673.2837, -1325.3040, 11.0715, 116.6886, 9, 1, 22, 70, 21, 13);
	addPlayerClass(3, 3, -673.2837, -1325.3040, 11.0715, 116.6886, 10, 1, 23, 80, 19, 23);
	addPlayerClass(4, 4, -673.2837, -1325.3040, 11.0715, 116.6886, 4, 1, 3, 35, 19, 15);
    addPlayerClass(5, 5, -673.2837, -1325.3040, 11.0715, 116.6886, 4, 1, 3, 35, 19, 15);
